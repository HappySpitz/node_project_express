...
export class CarMapper {
    public toResponse(car: ICar): ICarResponse {
        return {
            ...
            averagePrice: additionalInformationService.getAveragePriceByRegion(car.region),
            averagePriceInUkraine: additionalInformationService.getAveragePriceInUkraine()
        };
    }
}
