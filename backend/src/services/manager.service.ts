...
class ManagerService {
    public async getWithPagination(query: IQuery): Promise<IPaginationResponse<IManager>> {
        try {
    ...
    public async update(userId: string, data: Partial<IManager>): Promise<IManager> {
        try {
