...
class AuthController {
    public async registerSeller(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async registerManager(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async sendActivateToken(
        ...
        try {
            const { user } = req.res.locals;
            await authService.sendActivateToken(
               user
            );
    ...
    public async changeTypeAccount(
        ...
        try {
            ...
            await authService.changeTypeAccount(
                _id
            );
